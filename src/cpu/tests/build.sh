...
$CC $CCARGS -march=rv32i -c add_tests.S -o add_tests.elf
...
clang-18 --target=riscv32 -march=rv32i -nostdlib -T linker_tiny.ld -O0 -fno-inline -g blinky.c -o blinky.elf
